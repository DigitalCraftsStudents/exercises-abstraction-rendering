    ...
    return `
        <div class="container d-flex flex-column justify-content-start align-items-center">
            ...
            <div class="w-50 text-center"> <!-- 0 -->
                <button onclick="playGame(0,0)">${game.board[0][0]}</button>
                <button onclick="playGame(0,1)">${game.board[0][1]}</button>
                <button onclick="playGame(0,2)">${game.board[0][2]}</button>
            </div>
            <div class="w-50 text-center">  <!-- 1 -->
                <button onclick="playGame(1,0)">${game.board[1][0]}</button>
                <button onclick="playGame(1,1)">${game.board[1][1]}</button>
                <button onclick="playGame(1,2)">${game.board[1][2]}</button>
            </div>
            <div class="w-50 text-center">  <!-- 2 -->
                <button onclick="playGame(2,0)">${game.board[2][0]}</button>
                <button onclick="playGame(2,1)">${game.board[2][1]}</button>
                <button onclick="playGame(2,2)">${game.board[2][2]}</button>
            </div>
        </div>
    `
}